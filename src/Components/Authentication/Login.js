...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    //       "token",
    //       JSON.stringify(resultHandle?.message.Access_Token)
    //     );
    //     localStorage.setItem(
    //       "user",
    ...
    <div className="login fadeIn">
      <div className="background">
        ...
        <p style={{ fontSize: "20px" }}>
          <strong>Origin 8 AI</strong> is a state of the art AI powred CRM.
        </p>
        <p>
          Need Analytics about your business to help grow ? We've got you
          covered.
        </p>
      ...
      <div className="login-box p-4">
        ...
        <Link className="forgot-link" to="/forgot-1">
          Forgot password ?
        </Link>
