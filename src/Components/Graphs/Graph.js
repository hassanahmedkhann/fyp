...
const Graph = () => {
  ...
  const years = [
    { text: "This year", value: 2022 },
    { text: "Last year", value: 2021 },
    ...
    <div className="graph d-flex justify-content-center flex-column align-items-center px-1">
      ...
      <div className="d-flex w-100 justify-content-between">
        <p
          ...
          className="pt-3 ps-4 my-2 text-start w-100 px-3"
        >
          Analytics for -{" "}
          {
            <>
              ...
              >
                {years.map((year, index) => (
                  <MenuItem sx={menuItemStyle} key={index} value={year.value}>
                    {year.text}
                  </MenuItem>
                ))}
              </Select>
        ...
        <span
          className="p-2 m-4"
          style={{ backgroundColor: "#F4752C", borderRadius: "40px" }}
        >
          <TimelineIcon style={{ fontSize: "30px", color: "white" }} />
        </span>
      </div>
