    ...
    try {
      ...
      if (resultHandle?.success === true) {
        ...
        setAlert({
          flag: true,
          status: 2,
          message: "No deleted clusters found!",
        });
        setOpen(false);
      }
    } catch (err) {
      ...
      <div className="campaign container-fluid">
        ...
        <Grid rowGap={1} container className="mb-4">
          ...
          >
            <Button
              ...
              className={`account-button ${!deletedFlag && "hold"}`}
              style={ButtonSX}
            >
              Existing Clusters
            </Button>
        ...
        {!deletedFlag ? (
          <div className="row row-cols-lg-3 row-cols-xl-4 row-cols-md-2 ">
            {clusterData
              ?.sort((a, b) => a?.clusterNumber - b?.clusterNumber)
          ...
          <div className="row row-cols-lg-3 row-cols-xl-4 row-cols-md-2 ">
            {deletedClusters?.length > 0 ? (
              <>
                {deletedClusters?.map((clusterData, index) => (
                  <div
                    key={index}
                    className="col p-0 d-flex justify-content-center"
                  >
                    <ClusterCard
                      reloadFunction={handleDeleted}
                      deleted
              ...
              <div className="d-flex justify-content-center w-100 mt-4 searchProduct">
                <img
                  style={{
                    width: "50%",
                    borderRadius: "30px",
      ...
      >
        <Box className="d-flex flex-column align-items-center" sx={style}>
          ...
          >
            ...
            <p className="mt-3 ms-2" style={{ color: "red" }}>
              <b>Remember!</b> this will erase all existing clusters and
              populate new ones.
            </p>
          </div>
          <p
          ...
          >
            ...
            />
            Getting new predictions may take some time.
          </p>
          <div className="d-flex justify-content-evenly">
            <button onClick={getNewPredictions} className="mt-2 btn-1">
              Yes
            </button>
            <button
