            ...
            <Grid container className='manage-products-container mb-4'>
                ...
                <Grid item xs={12} sm={12} md={6}>
                    <div className="manage-card-container">
                        ...
                        <input className="manage-products-input" placeholder="Type here.." onChange={handleChange('productName')} type="text" />
                    </div>
                    <div className="manage-card-container ">
                        <label className="manage-products-labels">Product ID</label>
                        <input disabled value={productID + 1} className="manage-products-input" placeholder="Type here.." onChange={handleChange('productID')} type="text" />
                    </div><div className="manage-card-container ">
                        <label className="manage-products-labels">Product Price</label>
                        <input className="manage-products-input" placeholder="Type here.." onChange={handleChange('unitPrice')} type="text" />
                    </div>
                    <div className="manage-card-container ">
                        <label className="manage-products-labels">Product Profit</label>
                        <input disabled value={formValues.unitPrice - formValues.unitCost} className="manage-products-input" placeholder="Type here.." onChange={handleChange('unitProfit')} type="text" />
                    </div>
                    <div className="manage-card-container ">
                        <label className="manage-products-labels">Product Cost</label>
                        <input className="manage-products-input" placeholder="Type here.." onChange={handleChange('unitCost')} type="text" />
                    </div>
                    <div className="manage-card-container ">
