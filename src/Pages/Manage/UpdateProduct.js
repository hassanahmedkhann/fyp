...
const UpdateProduct = (props) => {
  ...
  const handleSearch = async (key) => {
    if (searchedProduct === 0 || searchedProduct === "")
      return setAlert({
        flag: true,
        status: 2,
    ...
    try {
      const essentials = {
        endPoint: `/products/${searchedProduct}`,
      };
      ...
      if (resultHandle?.success === true) {
        ...
        if (key == 2) {
          ...
          if (!resultHandle?.message?.length)
            return setAlert({
              flag: true,
              status: 2,
  ...
  const handleSubmit = () => {
    const data = {
      ...
      productCategory:
        formValues?.productCategory || productData?.productCategory,
    ...
    if (parseInt(data.unitCost) > parseInt(data.unitPrice)) {
      setAlert({
        flag: true,
        status: 2,
        message: "Product cost can not be greater than product price!",
      });
      validationFlag = true;
    }
    if (
      parseInt(data.unitCost) === 0 ||
      parseInt(data.unitPrice) === 0 ||
      parseInt(data.unitProfit) === 0
    ) {
    ...
    try {
      ...
      if (resultHandle?.success === true) {
        ...
        setAlert({
          flag: true,
          status: 1,
          message: resultHandle?.message.Success,
        });
        setTimeout(() => {
          navigate("/products");
        }, 1000);
  ...
  return (
    <div className="manage-products fadeUp">
      <Grid>
        ...
        {props.choice === 1 && (
          <h2 className={`mb-2 ms-4 text-left mt-3 ${existFlag && "margin"}`}>
            ...
            <div className="my-4">
              <div>
                <input
                  ...
                  className="manage-products-input ms-4"
                ...
                <Button
                  ...
                  sx={checkButton}
                  className="mt-2 ms-2 account-button"
                >
            ...
            {!productsSearched && (
              <div className="d-flex justify-content-center searchProduct">
                <img
                  style={{
                    width: "40%",
                    borderRadius: "38% 62% 19% 81% / 66% 65% 35% 34%",
                  }}
                  src={search}
                />
              </div>
      ...
      >
        <Box
          className="modalStyle d-flex flex-column align-items-center"
          sx={modalStyle}
        >
          ...
          <div className="d-flex justify-content-evenly mt-4">
            <button disabled onClick={handleChoice} className="ms-2 btn-1">
              Yes
            </button>
            <button onClick={handleCancel} className="ms-2 btn-2">
              No
            </button>
          </div>
        </Box>
          ...
          <Grid item xs={12} sm={12} md={6}>
            <div className="manage-card-container">
              ...
              <input
                ...
                value={ "Product" || formValues?.productName }
            ...
            <div className="manage-card-container ">
              ...
              <input
                value={ 456 || formValues?.unitPrice }
                className="manage-products-input"
                placeholder="Type here.."
            ...
            <div className="manage-card-container ">
              ...
              <input
                value={ 456 ||  formValues?.unitProfit }
                className="manage-products-input"
                placeholder="Type here.."
            ...
            <div className="manage-card-container ">
              ...
              <Select
                ...
                value={formValues?.productCategory || "Footwear"}
                label="Timeline"
          ...
          <Grid item xs={12} sm={6}>
            ...
            >
              ...
              <Avatar
                ...
                src={image || productData?.productImage}
              />
            </div>
          </Grid>
          <Grid className="text-center mt-3 w-100">
