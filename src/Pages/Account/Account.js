...
const Account = () => {
  ...
  const handleImageSelection = () => {
    ...
    setImage({
      preview: "",
      selected: JSON.parse(localStorage.getItem("image")),
    });
    setOpenModal(false);
  ...
  const handleForm = () => {
    return setAlert({
      flag: true,
      status: 1,
      message: "This is a static button. API is disconnected!",
    });
    ...
    if (!val) {
      return setAlert({
        ...
        status: 2,
        message:
          "Min length should be 8 with 1 special character and 1 Capital letter",
      });
    }
    ...
    const accountData = {
      ...
      profileImage:
        image?.selected?.length > 0 ? image?.selected : user?.profileImage,
    };
    ...
    try {
      ...
      if (resultHandle?.success === true) {
        ...
        localStorage.setItem(
          "user",
          JSON.stringify(resultHandle?.message.User_Data)
        );
        setTimerFlag(true);
        setTimeout(() => {
          setTimerFlag(false);
            ...
            <div className="p-0 col-12 col-lg-6">
              <form className="account-text justify-content-center">
                ...
                <TextField
                  fullWidth
                  sx={formStyle}
                  defaultValue={values.companyName || "Origin8"}
                  variant="standard"
                  InputProps={{
                    readOnly: true,
                  }}
                ...
                <TextField
                  ...
                  variant="standard"
                  type="email"
                  defaultValue={values.email || "test@origin8.com"}
                  InputProps={{
                    readOnly: true,
                  }}
                  helperText="Can not change"
                  ...
                  <TextField
                    helperText={
                      values.password !== values.confirmPassword
                        ...
                        : "Note: Min length should be 8 with 1 special character and 1 Capital letter"
                    }
                    variant="standard"
                ...
                >
                  ...
                  >
                    ...
                    <Avatar
                      className="account-avatar"
                      sx={{ height: "300px", width: "300px" }}
                      src={image.preview.length > 0 ? image.preview : null}
                    />
                    <button
                      style={buttonSX}
                      onClick={handleImageSelection}
                      className="account-button mt-2 p-2"
                    >
                      Select this Image
                    </button>
                  </Box>
